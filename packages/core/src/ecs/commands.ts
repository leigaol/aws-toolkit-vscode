...
export const runCommandInContainer = Commands.register('_aws.ecs.runCommandInContainer', (obj?: unknown) => {
...
export const openTaskInTerminal = Commands.register('_aws.ecs.openTaskInTerminal', (obj?: unknown) => {
    return telemetry.ecs_runExecuteCommand.run(async span => {
