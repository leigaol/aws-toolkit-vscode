...
export const runCommandInContainer = Commands.register('baws.ecs.runCommandInContainer', (obj?: unknown) => {
...
export const openTaskInTerminal = Commands.register('baws.ecs.openTaskInTerminal', (obj?: unknown) => {
    return telemetry.ecs_runExecuteCommand.run(async span => {
